                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group mt-0">
                                                            <select class="selectpicker" data-style="btn select-with-transition" title="Pilih Level User" data-size="7" name="level_user">
                                                                <option <?php if($level_user=="kepala sekolah"){echo "SELECTED";} ?> value="kepala sekolah">Kepala Sekolah</option>
                                                                <option <?php if($level_user=="sekertaris"){echo "SELECTED";} ?> value="sekertaris">Sekertaris</option>
                                                                <option <?php if($level_user=="wakasek"){echo "SELECTED";} ?> value="wakasek">Wakasek</option>
